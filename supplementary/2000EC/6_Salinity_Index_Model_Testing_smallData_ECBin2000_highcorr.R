# ========================= Test binary EC (2000) with highcorr ==============================
library(tidyverse)
library(ggplot2)
...
write.csv(results_df, "outputs/2000EC/smalldata_model_results_ECbin_highcorr_80_20strat.csv")
...
write.csv(results_df, "outputs/2000EC/smalldata_model_results_ECbin_highcorr_80_20random.csv")
