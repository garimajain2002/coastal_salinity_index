...
write.csv(results_df, "outputs/2000EC/smalldata_model_results_ECbin_all_80_20strat.csv")
...
write.csv(results_df, "outputs/2000EC/smalldata_model_results_ECbin_all_80_20random.csv")
