...
# All data already in reflectance 
...
soil_data$EC_bin <- ifelse(soil_data$EC >= 2000, 1, 0)
soil_data$EC_cat <- ifelse(soil_data$EC < 2000, 0, 
...
write.csv(soil_data, "data/soil_data_allindices_2000EC.csv")
...
soil_data <- read.csv("data/soil_data_allindices_2000EC.csv")

head(soil_data)

# First just simply check the linear correlation between EC and other bands/indices using a correlation matrix 
cor_matrix <- cor(soil_data[, c("EC","pH" ,"Soil_Moisture_Lab","Blue", "Red", "Green", "NIR", "SWIR1", "SWIR2",
...
print(cor_matrix)
write.csv(cor_matrix, "outputs/EC_bands_correlation_geom_2000EC.csv")
...
# geomedian results are very similar just a different order and magnitude of correlation changes a little bit


# 2000 threshold - same because EC in this is the same cont. value and not binary. 

# Similarly none of the relationships below will change either since those are all with cont. EC also
...
# Blue Linear 
ggplot(soil_data, aes(x = Blue, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_Blue_Linear_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = Blue, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_Blue_Loess_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = Blue, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_Blue_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = Blue, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_Blue_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = Red, y = EC)) +
  geom_point(color = "orange") +  # Scatter points
  geom_smooth(method = "gam", color = "black", se = FALSE) +  # fitted
  labs(title = "Scatterplot of EC vs Red Band: GAM Fit", x = "Red", y = "EC") +
  theme_minimal()
ggsave("outputs/EC_Red_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = Red, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_Red_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")


# Green Curve (Generalised Additive Model - fit various curves)
ggplot(soil_data, aes(x = Green, y = EC)) +
  geom_point(color = "orange") +  # Scatter points
  geom_smooth(method = "gam", color = "black", se = FALSE) +  # fitted
  labs(title = "Scatterplot of EC vs Green Band: GAM Fit", x = "Green", y = "EC") +
  theme_minimal()
ggsave("outputs/EC_Green_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = Green, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_Green_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")


# NIR Curve (Generalised Additive Model - fit various curves)
ggplot(soil_data, aes(x = NIR, y = EC)) +
  geom_point(color = "orange") +  # Scatter points
  geom_smooth(method = "gam", color = "black", se = FALSE) +  # fitted
  labs(title = "Scatterplot of EC vs NIR Band: GAM Fit", x = "NIR", y = "EC") +
  theme_minimal()
ggsave("outputs/EC_NIR_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NIR, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NIR_poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")



# SWIR1 Curve (Generalised Additive Model - fit various curves)
ggplot(soil_data, aes(x = SWIR1, y = EC)) +
  geom_point(color = "orange") +  # Scatter points
  geom_smooth(method = "gam", color = "black", se = FALSE) +  # fitted
  labs(title = "Scatterplot of EC vs SWIR1 Band: GAM Fit", x = "SWIR1", y = "EC") +
  theme_minimal()
ggsave("outputs/EC_SWIR1_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = SWIR1, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_SWIR1_poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = SWIR2, y = EC)) +
  geom_point(color = "orange") +  # Scatter points
  geom_smooth(method = "gam", color = "black", se = FALSE) +  # fitted
  labs(title = "Scatterplot of EC vs SWIR2 Band: GAM Fit", x = "SWIR2", y = "EC") +
  theme_minimal()
ggsave("outputs/EC_SWIR2_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# seems to have no relation
...
ggplot(soil_data, aes(x = SWIR2, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_SWIR2_poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NBR, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NBR_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# seems to have no relation
...
ggplot(soil_data, aes(x = NBG, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NBG_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NBNIR, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NBNIR_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NBNIR, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NBNIR_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NBSWIR1, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NBSWRIR1_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# What fit? 
#polynomial
ggplot(soil_data, aes(x = NBSWIR1, y = EC)) +
  geom_point(color = "orange") +  # Scatter points
  ...
  theme_minimal()
ggsave("outputs/EC_NBSWRIR1_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NBSWIR2, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NBSWRIR2_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# gaussian fit?  
#polynomial
ggplot(soil_data, aes(x = NBSWIR2, y = EC)) +
  geom_point(color = "orange") +  # Scatter points
  ...
  theme_minimal()
ggsave("outputs/EC_NBSWRIR2_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NDVI, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NDVI_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NDSI2, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NDSI2_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NDSI2, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NDSI2_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NRSWIR1, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NRSWIR1_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white") 
...
ggplot(soil_data, aes(x = NRSWIR1, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NRSWIR1_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NRSWIR2, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NRSWIR2_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# gaussian fit? 
...
ggplot(soil_data, aes(x = NRSWIR2, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NRSWIR2_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NDWI, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NDWI_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NDWI, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NDWI_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NGSWIR1, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NGSWIR1_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NGSWIR1, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NGSWIR1_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NGSWIR2, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NGSWIR2_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
#Gaussian fit? 
...
ggplot(soil_data, aes(x = NGSWIR2, y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NGSWIR2_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NNIRSWIR1 , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NNIRSWIR1_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NNIRSWIR1 , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NNIRSWIR1_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NNIRSWIR2 , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NNIRSWIR2_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# mostly linear but a little exponential? 
#polynomial
ggplot(soil_data, aes(x = NNIRSWIR2 , y = EC)) +
  geom_point(color = "orange") +  # Scatter points
  ...
  theme_minimal()
ggsave("outputs/EC_NNIRSWIR2_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NDSI1 , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NDSI1_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# essentially linear
...
ggplot(soil_data, aes(x = NDSI1 , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_NDSI1_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = SI1 , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_SI1_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = SI1 , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_SI1_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = SI2 , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_SI2_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# linear with slight quadratic fit
#polynomial
ggplot(soil_data, aes(x = SI2 , y = EC)) +
  geom_point(color = "orange") +  # Scatter points
  ...
  theme_minimal()
ggsave("outputs/EC_SI2_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = SI3 , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_SI3_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# essentially linear
...
ggplot(soil_data, aes(x = SI4 , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_SI4_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# essentially linear
#poly
ggplot(soil_data, aes(x = SI4 , y = EC)) +
  geom_point(color = "orange") +  # Scatter points
  geom_smooth(method = "lm", formula = y ~ poly(x, 2), color = "black") +  # quadratic curve
  labs(title = "Scatterplot of EC vs SI4: Polynomial Fit ", x = "SI4", y = "EC") +
  theme_minimal()
ggsave("outputs/EC_SI4_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = SI5 , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_SI5_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# no relationship
...
ggplot(soil_data, aes(x = SAVI , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_SAVI_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
# quadratic?
#polynomial
ggplot(soil_data, aes(x = SAVI , y = EC)) +
  geom_point(color = "orange") +  # Scatter points
  ...
  theme_minimal()
ggsave("outputs/EC_SAVI_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = VSSI , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_VSSI_GAM_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = VSSI , y = EC)) +
  ...
  theme_minimal()
ggsave("outputs/EC_VSSI_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NDWI , y = Soil_Moisture_Lab)) +
  ...
  theme_minimal()
ggsave("outputs/Moisture_NDWI_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NBNIR , y = Soil_Moisture_Lab)) +
  ...
  theme_minimal()
ggsave("outputs/Moisture_NBNIR_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")

# NRSWIR2
ggplot(soil_data, aes(x = NRSWIR2 , y = Soil_Moisture_Lab)) +
  geom_point(color = "blue") +  # Scatter points
  geom_smooth(method = "lm", formula = y ~ poly(x, 2), color = "black") +  # quadratic curve
  labs(title = "Scatterplot of Moisture vs NRSWIR2: Polynomial Fit ", x = "NRSWIR2", y = "Soil Moisture") +
  theme_minimal()
ggsave("outputs/Moisture_NRSWIR2_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")

# SI4
ggplot(soil_data, aes(x = SI4 , y = Soil_Moisture_Lab)) +
  geom_point(color = "blue") +  # Scatter points
  geom_smooth(method = "lm", formula = y ~ poly(x, 2), color = "black") +  # quadratic curve
  labs(title = "Scatterplot of Moisture vs SI4: Polynomial Fit ", x = "SI4", y = "Soil Moisture") +
  theme_minimal()
ggsave("outputs/Moisture_SI4_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")

# Red
ggplot(soil_data, aes(x = Red , y = Soil_Moisture_Lab)) +
  geom_point(color = "blue") +  # Scatter points
  geom_smooth(method = "lm", formula = y ~ poly(x, 2), color = "black") +  # quadratic curve
  labs(title = "Scatterplot of Moisture vs Red: Polynomial Fit ", x = "Red", y = "Soil Moisture") +
  theme_minimal()
ggsave("outputs/Moisture_Red_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")


# SWIR2
ggplot(soil_data, aes(x = SWIR2 , y = Soil_Moisture_Lab)) +
  geom_point(color = "blue") +  # Scatter points
  geom_smooth(method = "lm", formula = y ~ poly(x, 2), color = "black") +  # quadratic curve
  labs(title = "Scatterplot of Moisture vs SWIR2: Polynomial Fit ", x = "SWIR2", y = "Soil Moisture") +
  theme_minimal()
ggsave("outputs/Moisture_SWIR2_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")


# Green
ggplot(soil_data, aes(x = Green , y = Soil_Moisture_Lab)) +
  geom_point(color = "blue") +  # Scatter points
  geom_smooth(method = "lm", formula = y ~ poly(x, 2), color = "black") +  # quadratic curve
  labs(title = "Scatterplot of Moisture vs Green: Polynomial Fit ", x = "Green", y = "Soil Moisture") +
  theme_minimal()
ggsave("outputs/Moisture_Green_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NRSWIR1 , y = Soil_Moisture_Lab)) +
  ...
  theme_minimal()
ggsave("outputs/Moisture_NRSWIR1_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = VSSI , y = Soil_Moisture_Lab)) +
  ...
  theme_minimal()
ggsave("outputs/Moisture_VSSI_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NNIRSWIR1 , y = Soil_Moisture_Lab)) +
  ...
  theme_minimal()
ggsave("outputs/Moisture_NNIRSWIR1_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NDSI1 , y = Soil_Moisture_Lab)) +
  ...
  theme_minimal()
ggsave("outputs/Moisture_NDSI1_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NGSWIR1 , y = Soil_Moisture_Lab)) +
  ...
  theme_minimal()
ggsave("outputs/Moisture_NGSWIR1_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
ggplot(soil_data, aes(x = NBSWIR2 , y = Soil_Moisture_Lab)) +
  ...
  theme_minimal()
ggsave("outputs/Moisture_NBSWIR2_Poly_geom.png", width = 8, height = 6, dpi = 300, bg = "white")
...
##### LINEAR MODEL FITS #####
# Bands
linear_Blue <- lm(EC ~ Blue, data = train_data)
linear_Red <- lm(EC ~ Red, data = train_data)
linear_Green <- lm(EC ~ Green, data = train_data)
linear_NIR <- lm(EC ~ NIR, data = train_data)
linear_SWIR1 <- lm(EC ~ SWIR1, data = train_data)
linear_SWIR2 <- lm(EC ~ SWIR2, data = train_data)
...
# Bands
poly_Blue <- lm(EC ~ poly(Blue,2), data = train_data)
poly_Red <- lm(EC ~ poly(Red,2), data = train_data)
poly_Green <- lm(EC ~ poly(Green,2), data = train_data)
poly_NIR <- lm(EC ~ poly(NIR,2), data = train_data)
poly_SWIR1 <- lm(EC ~ poly(SWIR1,2), data = train_data)
poly_SWIR2 <- lm(EC ~ poly(SWIR2,2), data = train_data)
...
# Bands 
log_Blue <- lm(log(EC) ~ Blue, data = train_data)
log_Red <- lm(log(EC) ~ Red, data = train_data)
log_Green <- lm(log(EC) ~ Green, data = train_data)
log_NIR <- lm(log(EC) ~ NIR, data = train_data)
log_SWIR1 <- lm(log(EC) ~ SWIR1, data = train_data)
log_SWIR2 <- lm(log(EC) ~ SWIR2, data = train_data)
...
linear_all <- lm(EC ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
...
poly_all <- lm(EC ~ poly(Blue,2) + poly(Red,2) + poly(Green,2) + poly(NIR,2) + poly(SWIR1,2) + poly(SWIR2,2) + 
...
log_all <- lm(log(EC) ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
                NDVI + NDWI + NDSI1 + NDSI2 + SI1 + SI2 + SI3 + SI4 + SI5 + SAVI + VSSI + 
                NBR + NBG + NBNIR + NBSWIR1 + NBSWIR2 + NRSWIR1 + NRSWIR2 + NGSWIR1 + NGSWIR2 + NNIRSWIR1 + NNIRSWIR2, data = train_data)
...
linear_highcor <- lm(EC ~ NIR + NDWI + NDSI2 + SAVI + NBNIR + NRSWIR1, data = train_data)
poly_highcor <- lm(EC ~ poly(NIR,2) + poly(NDWI,2) + poly(NDSI2,2) + poly(SAVI,2) + poly(NBNIR,2) + poly(NRSWIR1,2), data = train_data)
log_highcor <- lm(log(EC) ~ NIR + NDWI + NDSI2 + SAVI + NBNIR + NRSWIR1, data = train_data)
...
full_stepwise_model <- lm(EC ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
                            NDVI + NDWI + NDSI1 + NDSI2 + SI1 + SI2 + SI3 + SI4 + SI5 + SAVI + VSSI + 
                            NBR + NBG + NBNIR + NBSWIR1 + NBSWIR2 + NRSWIR1 + NRSWIR2 + NGSWIR1 + NGSWIR2 + NNIRSWIR1 + NNIRSWIR2, data = train_data)
...
rf_model <- randomForest(EC ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
                           NDVI + NDWI + NDSI1 + NDSI2 + SI1 + SI2 + SI3 + SI4 + SI5 + SAVI + VSSI + 
...
# R2 testing for 2000EC binary is 0.65 (dropped as compared to 1900 EC - likely because slightly more unbalanced data)
...
bagging_model <- randomForest(EC ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
                                NDVI + NDWI + NDSI1 + NDSI2 + SI1 + SI2 + SI3 + SI4 + SI5 + SAVI + VSSI + 
...
train <- subset(train_data, select = c("EC", "Blue", "Red", "Green", "NIR", "SWIR1", "SWIR2", 
                                       "NDVI", "NDWI", "NDSI1", "NDSI2", "SI1", "SI2", "SI3", "SI4", "SI5", "SAVI", "VSSI", 
                                       "NBR", "NBG", "NBNIR", "NBSWIR1", "NBSWIR2", "NRSWIR1", "NRSWIR2", "NGSWIR1", "NGSWIR2", "NNIRSWIR1", "NNIRSWIR2"))

test <- subset(test_data, select = c("EC", "Blue", "Red", "Green", "NIR", "SWIR1", "SWIR2", 
                                     "NDVI", "NDWI", "NDSI1", "NDSI2", "SI1", "SI2", "SI3", "SI4", "SI5", "SAVI", "VSSI", 
                                     "NBR", "NBG", "NBNIR", "NBSWIR1", "NBSWIR2", "NRSWIR1", "NRSWIR2", "NGSWIR1", "NGSWIR2", "NNIRSWIR1", "NNIRSWIR2"))
...
ann_model <- nnet(EC ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
                    NDVI + NDWI + NDSI1 + NDSI2 + SI1 + SI2 + SI3 + SI4 + SI5 + SAVI + VSSI + 
...
#RF, Bagging, and ANN seem promising to be tested further with 100 iterations. 
...
#     lm(log(EC) ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
#          NDVI + NDWI + NDSI1 + NDSI2 + SI1 + SI2 + SI3 + SI4 + SI5 + SAVI + VSSI + 
#          NBR + NBG + NBNIR + NBSWIR1 + NBSWIR2 + NRSWIR1 + NRSWIR2 + NGSWIR1 + NGSWIR2 + NNIRSWIR1 + NNIRSWIR2, data = train_data)
#   }, error = function(e) {
...
#   
#   ols_model <- tryCatch({
#   lm(EC ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
#        NDVI + NDWI + NDSI1 + NDSI2 + SI1 + SI2 + SI3 + SI4 + SI5 + SAVI + VSSI + 
#        NBR + NBG + NBNIR + NBSWIR1 + NBSWIR2 + NRSWIR1 + NRSWIR2 + NGSWIR1 + NGSWIR2 + NNIRSWIR1 + NNIRSWIR2, data = train_data)
# }, error = function(e) {
...
#   
#   poly_all <- tryCatch({
#     lm(EC ~ poly(Blue,2) + poly(Red,2) + poly(Green,2) + poly(NIR,2) + poly(SWIR1,2) + poly(SWIR2,2) + 
#                    poly(NDVI,2) + poly(NDWI,2) + poly(NDSI1,2) + poly(NDSI2,2) + poly(SI1,2) + poly(SI2,2) + poly(SI3,2) + poly(SI4,2) + poly(SI5,2) + poly(SAVI,2) + poly(VSSI,2) + 
#                    poly(NBR,2) + poly(NBG,2) + poly(NBNIR,2) + poly(NBSWIR1,2) + poly(NBSWIR2,2) + poly(NRSWIR1,2) + poly(NRSWIR2,2) + poly(NGSWIR1,2) + poly(NGSWIR2,2) + poly(NNIRSWIR1,2) + poly(NNIRSWIR2,2) , data = train_data)
#   }, error = function(e) {
...
#   poly_corr <- tryCatch({
#     lm(EC ~ poly(NIR,2) + poly(NDWI,2) + poly(NDSI2,2) + poly(SAVI,2) + poly(NBNIR,2) + poly(NRSWIR1,2), data = train_data)
#       }, error = function(e) {
...
#     stepAIC(lm(EC ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
#                  NDVI + NDWI + NDSI1 + NDSI2 + SI1 + SI2 + SI3 + SI4 + SI5 + SAVI + VSSI + 
...
#   ### 6. Random Forest ###
#   rf_model <- tryCatch({
#     randomForest(EC ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
#                    NDVI + NDWI + NDSI1 + NDSI2 + SI1 + SI2 + SI3 + SI4 + SI5 + SAVI + VSSI + 
#                    NBR + NBG + NBNIR + NBSWIR1 + NBSWIR2 + NRSWIR1 + NRSWIR2 + NGSWIR1 + NGSWIR2 + NNIRSWIR1 + NNIRSWIR2, data = train_data, ntree = 500)
#   }, error = function(e) {
...
#   
#   ann_model <- tryCatch({
#     nnet(EC ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
#            NDVI + NDWI + NDSI1 + NDSI2 + SI1 + SI2 + SI3 + SI4 + SI5 + SAVI + VSSI + 
...
#     train(
#       #EC ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
#       #      NBNIR + NDSI2 + NRSWIR1 + NDWI + SAVI,
#           EC ~ NDWI + Green + SWIR2 + NBR + NBNIR + NBSWIR2 + 
...
# 
# # Save results
# write.csv(results_df, "outputs/100_iterationesults_EC_binary_stratified_lasso.csv")
# 
# 
# 
# 
...
#       #EC ~ Blue + Red + Green + NIR + SWIR1 + SWIR2 + 
#       #      NBNIR + NDSI2 + NRSWIR1 + NDWI + SAVI,
#       EC ~ NDWI + NDSI + Green + SWIR2 + NBR + NBNIR + NBSWIR2 + 
#         NRSWIR2 + NGSWIR1 + NDSI1 + VSSI,
#           data = train_data, method = "glm", family = binomial(link='logit'), trControl = train_control)
#   }, error = function(e) {
#     message("Logistic model failed on iteration: ", i)
...
# # selected predictors
# # if Dist_Sea is kept:
# # Dist_Sea, NDWI, NDSI, Green, SWIR2, NBNIR, NBSWIR2, NRSWIR1, NGSWIR1, VSSI
# # if Dist_Sea is removed:
# # NDWI, NDSI, Green, SWIR2, NBR, NBNIR, NBSWIR2, NRSWIR2, NGSWIR1, NDSI1, VSSI
# 
# 
# 
# 
