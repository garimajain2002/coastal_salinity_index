...
# 2024 JSP
landsat_image <- stack("data/tifs/geomedian_harmonised_New5classified/OD_4_geomedian_2024_Feb.tif")
aqua_image <- stack("data/tifs/geomedian_harmonised_New5classified/OD_4_classified_2024.tif") #stack() reads the bands into a multi-layer object
...
writeRaster(predicted_raster, "outputs/2000EC/OD4_predicted_EC_raster_2024.tif", format = "GTiff", overwrite = TRUE)
ggsave("outputs/2000EC/OD4_predicted_EC_map_2024.png", plot = predicted_EC, width = 8, height = 6, dpi = 300)
...
# # Change filename based on original image selection (JSP/SA)
ggsave("outputs/2000EC/OD4_predicted_Aqua_map_2024.png", plot = predicted_Aqua, width = 8, height = 6, dpi = 300)
writeRaster(aqua_mask_raster, "outputs/2000EC/OD4_predicted_Aqua_raster_2024.tif", format = "GTiff", overwrite = TRUE)
...
ggsave("outputs/2000EC/OD4_predicted_ECAqua_map_2024.png", plot = predicted_ECAqua, width = 8, height = 6, dpi = 300)
writeRaster(predicted_raster, "outputs/2000EC/OD4_predicted_ECAqua_raster_2024.tif", format = "GTiff", overwrite = TRUE)

write.csv(final_df, "outputs/2000EC/2024_OD4_predicted_ECAqua_df.csv")
