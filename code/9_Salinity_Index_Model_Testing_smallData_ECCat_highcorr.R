...
write.csv(results_df, "outputs/smalldata_model_results_ECCat_highcorr_80_20strat.csv")
...
write.csv(results_df, "outputs/smalldata_model_results_ECCat_highcorr_80_20random.csv")
