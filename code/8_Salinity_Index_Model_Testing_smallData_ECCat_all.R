...
write.csv(results_df, "outputs/smalldata_model_results_ECcat_all_80_20strat.csv")
...
write.csv(results_df, "outputs/smalldata_model_results_ECcat_all_80_20random.csv")
