...
writeRaster(predicted_raster, "outputs/JSP_predicted_EC_raster_1995.tif", format = "GTiff", overwrite = TRUE)
ggsave("outputs/JSP_predicted_EC_map_1995.png", plot = predicted_EC, width = 8, height = 6, dpi = 300)
...
# Change filename based on original image selection (JSP/SA)
ggsave("outputs/JSP_predicted_Aqua_map_1995.png", plot = predicted_Aqua, width = 8, height = 6, dpi = 300)
writeRaster(aqua_mask_raster, "outputs/JSP_predicted_Aqua_raster_1995.tif", format = "GTiff", overwrite = TRUE)
