...
# 2010 JSP
landsat_image <- stack("data/tifs/2010_JSP_Composite_AllBands.tif")
...
writeRaster(predicted_raster, "outputs/JSP_predicted_EC_raster_2010.tif", format = "GTiff", overwrite = TRUE)
ggsave("outputs/JSP_predicted_EC_map_2010.png", plot = predicted_EC, width = 8, height = 6, dpi = 300)
...
# Change filename based on original image selection (JSP/SA)
ggsave("outputs/JSP_predicted_Aqua_map_2010.png", plot = predicted_Aqua, width = 8, height = 6, dpi = 300)
writeRaster(aqua_mask_raster, "outputs/JSP_predicted_Aqua_raster_2010.tif", format = "GTiff", overwrite = TRUE)
...
# Change filename based on original image selection (JSP/SA)
ggsave("outputs/JSP_predicted_ECAqua_map_2010.png", plot = predicted_ECAqua, width = 8, height = 6, dpi = 300)
writeRaster(predicted_raster, "outputs/JSP_predicted_ECAqua_raster_2010.tif", format = "GTiff", overwrite = TRUE)

write.csv(final_df, "outputs/2010_JSP_predicted_ECAqua_df.csv")
